...
namespace Medico.Data.Migrations
{
    ...
    [Migration("20200321142833_Drop_CategoryName_And_SelectableListName_From_CategorySelectableList_View")]
    partial class Drop_CategoryName_And_SelectableListName_From_CategorySelectableList_View
    {
            ...
            modelBuilder.Entity("Medico.Domain.Models.Template", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            DetailedTemplateHtml = "<p>The claimant <span id=\"fbf5afea-476a-7ff5-8c35-6db494510011\" metadata=\"#documentation::denies#\">#documentation::denies#</span> <span id=\"1d519e30-4d42-7912-72e4-3489ed5ac25c\" metadata=\"#documentation::severity#\">#documentation::severity#</span> significant impact on activities of daily living. The claimant <span id=\"ccf891dc-9bdd-87e3-7d6e-cb7f83a263e0\" metadata=\"#documentation::not#\">#documentation::not#</span> able to complete self-care activities including <span id=\"49f7c84c-b233-ae11-b3b4-477e5aa4cb3c\" metadata=\"#documentation::adlActivities#\">#documentation::adlActivities#</span>​​​​​​​ . The claimant <span id=\"f0500fde-251b-4c82-1f35-1c0dc4911abc\" metadata=\"#documentation::not#\">#documentation::not#</span> able to ambulate <span id=\"be2cdcc4-c405-02db-1265-892ec90eb94a\" metadata=\"#documentation::with#\">#documentation::with#</span> assistance and <span id=\"83b69b91-2d87-38f9-43f0-4eeed505d5fa\" metadata=\"#documentation::with#\">#documentation::with#</span> difficulty. The claimant <span id=\"69b704b4-3069-556d-11de-091e5ed1bf69\" metadata=\"#documentation::not#\">#documentation::not#</span>&nbsp;not confined to bed, and <span id=\"5ec07132-9e31-b2fa-a7a7-d060363f8294\" metadata=\"#documentation::does#\">#documentation::does#</span> get adequate sleep. The claimant <span id=\"153a95fc-097a-645d-947e-abb7eecfd2df\" metadata=\"#documentation::can#\">#documentation::can#</span> drive a vehicle.</p>",
                            InitialDetailedTemplateHtml = "<p>The claimant <span id=\"fbf5afea-476a-7ff5-8c35-6db494510011\" metadata=\"#documentation::denies#\">denies</span> <span id=\"1d519e30-4d42-7912-72e4-3489ed5ac25c\" metadata=\"#documentation::severity#\">mild</span> significant impact on activities of daily living. The claimant <span id=\"ccf891dc-9bdd-87e3-7d6e-cb7f83a263e0\" metadata=\"#documentation::not#\">is</span> able to complete self-care activities including <span id=\"49f7c84c-b233-ae11-b3b4-477e5aa4cb3c\" metadata=\"#documentation::adlActivities#\">activities of daily living</span>​​​​​​​ . The claimant <span id=\"f0500fde-251b-4c82-1f35-1c0dc4911abc\" metadata=\"#documentation::not#\">is</span> able to ambulate <span id=\"be2cdcc4-c405-02db-1265-892ec90eb94a\" metadata=\"#documentation::with#\">without</span> assistance and <span id=\"83b69b91-2d87-38f9-43f0-4eeed505d5fa\" metadata=\"#documentation::with#\">without</span> difficulty. The claimant <span id=\"69b704b4-3069-556d-11de-091e5ed1bf69\" metadata=\"#documentation::not#\">is</span>&nbsp;not confined to bed, and <span id=\"5ec07132-9e31-b2fa-a7a7-d060363f8294\" metadata=\"#documentation::does#\">does</span> get adequate sleep. The claimant <span id=\"153a95fc-097a-645d-947e-abb7eecfd2df\" metadata=\"#documentation::can#\">can</span> drive a vehicle.</p>",
                            IsActive = true,
                            IsHistorical = false,
                            IsRequired = false,
                        ...
                        new
                        {
                            ...
                            DefaultTemplateHtml = "",
                            DetailedTemplateHtml = "<p style=\"color: #000000; font-family: Times New Roman; font-size: 16px; font-style: normal; font-variant: normal; font-weight: 400; letter-spacing: normal; orphans: 2; text-align: left; text-decoration: none; text-indent: 0px; text-transform: none; -webkit-text-stroke-width: 0px; white-space: normal; word-spacing: 0px;\">Claimant was advised prior to exam that this is not a complete physical but is an administrative exam and a physician patient relationship has not been established and according to DDS requirements the claimant is not required to perform any maneuvers that cause pain or discomfort. Findings related to this examination were discussed with the claimant prior to termination of the exam and that the physician does not make determination of disability, this determination is made by DDS. Additionally, the physical exam and paperwork take 30 minutes. Identification verified with a&nbsp;&nbsp;<span id=\"7135114a-c01c-d124-ff91-044a98fd3d83\" metadata=\"#documentation::identification#\">#documentation::identification#</span>&nbsp;</p>",
                            InitialDetailedTemplateHtml = "<p style=\"color: #000000; font-family: Times New Roman; font-size: 16px; font-style: normal; font-variant: normal; font-weight: 400; letter-spacing: normal; orphans: 2; text-align: left; text-decoration: none; text-indent: 0px; text-transform: none; -webkit-text-stroke-width: 0px; white-space: normal; word-spacing: 0px;\">Claimant was advised prior to exam that this is not a complete physical but is an administrative exam and a physician patient relationship has not been established and according to DDS requirements the claimant is not required to perform any maneuvers that cause pain or discomfort. Findings related to this examination were discussed with the claimant prior to termination of the exam and that the physician does not make determination of disability, this determination is made by DDS. Additionally, the physical exam and paperwork take 30 minutes. Identification verified with a&nbsp;&nbsp;<span id=\"7135114a-c01c-d124-ff91-044a98fd3d83\" metadata=\"#documentation::identification#\">passport</span>&nbsp;</p>",
                            IsActive = true,
                            IsHistorical = false,
                            IsRequired = false,
