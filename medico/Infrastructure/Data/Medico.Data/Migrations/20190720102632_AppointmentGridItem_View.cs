...
{
    public partial class AppointmentGridItem_View : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.Sql(@"
                CREATE VIEW AppointmentGridItem AS
                SELECT a.Id, a.Allegations, a.StartDate, a.EndDate, a.AppointmentStatus, l.Name AS LocationName, l.Id AS LocationId, r.Id AS RoomId, r.Name AS RoomName, p.Id AS PatientId, p.FirstName AS PatientFirstName, p.LastName AS PatientLastName, p.DateOfBirth AS PatientDateOfBirth, d.Id AS PhysicianId, d.FirstName AS PhysicianFirstName, d.LastName AS PhysicianLastName, n.Id AS NurseId, n.FirstName AS NurseFirstName, n.LastName AS NurseLastName FROM Appointment AS a 
