...
namespace Medico.Data.Migrations
{
    ...
    [Migration("20191226230802_Update_Company_PatientChartConfigId_Column_Not_Null")]
    partial class Update_Company_PatientChartConfigId_Column_Not_Null
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Medico.Domain.Models.Company", b =>
                {
                    ...
                    b.Property<Guid?>("PatientChartConfigId");
            ...
            modelBuilder.Entity("Medico.Domain.Models.PatientChartConfig", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasDefaultValueSql("newsequentialid()");
                    ...
                    b.Property<string>("PatientChartJsonConfig")
                        .IsRequired();
            ...
            modelBuilder.Entity("Medico.Domain.Models.PatientChartConfig", b =>
                {
                    b.HasOne("Medico.Domain.Models.Company", "Company")
                        .WithOne("PatientChartConfig")
                        .HasForeignKey("Medico.Domain.Models.PatientChartConfig", "CompanyId")
                        .OnDelete(DeleteBehavior.Cascade);
                });
