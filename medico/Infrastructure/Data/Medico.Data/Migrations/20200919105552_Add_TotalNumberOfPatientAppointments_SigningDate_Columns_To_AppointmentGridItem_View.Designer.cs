...
namespace Medico.Data.Migrations
{
    ...
    [Migration("20200919105552_Add_TotalNumberOfPatientAppointments_SigningDate_Columns_To_AppointmentGridItem_View")]
    partial class Add_TotalNumberOfPatientAppointments_SigningDate_Columns_To_AppointmentGridItem_View
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Medico.Domain.Models.ExpressionReferenceTable", b =>
                {
                    b.Property<Guid>("ExpressionId");

                    b.Property<Guid>("ReferenceTableId");

                    b.HasKey("ExpressionId", "ReferenceTableId");

                    b.HasIndex("ReferenceTableId");

                    b.ToTable("ExpressionReferenceTable");
                });
            ...
            modelBuilder.Entity("Medico.Domain.Models.ReferenceTable", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("9afeec1e-8642-4003-8249-8132840f1bf8"),
                            Data = "{\"header\":[{\"title\":\"Id\",\"type\":\"string\",\"visible\":false},{\"title\":\"Title\",\"type\":\"string\",\"visible\":true},{\"title\":\"Template\",\"type\":\"string\",\"visible\":true},{\"title\":\"MaxAge\",\"type\":\"number\",\"visible\":true},{\"title\":\"MinAge\",\"type\":\"number\",\"visible\":true},{\"title\":\"MinValue\",\"type\":\"number\",\"visible\":true},{\"title\":\"MaxValue\",\"type\":\"number\",\"visible\":true}],\"body\":[]}",
            ...
            modelBuilder.Entity("Medico.Domain.Models.TemplateExpression", b =>
                {
                    b.Property<Guid>("TemplateId");

                    b.Property<Guid>("ExpressionId");

                    b.HasKey("TemplateId", "ExpressionId");

                    b.HasIndex("ExpressionId");

                    b.ToTable("TemplateExpression");
                });
            ...
            modelBuilder.Entity("Medico.Domain.Models.ExpressionReferenceTable", b =>
                {
                    b.HasOne("Medico.Domain.Models.Expression", "Expression")
                        .WithMany("ExpressionReferenceTables")
                        .HasForeignKey("ExpressionId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("Medico.Domain.Models.ReferenceTable", "ReferenceTable")
                        .WithMany("ReferenceTableExpressions")
            ...
            modelBuilder.Entity("Medico.Domain.Models.TemplateExpression", b =>
                {
                    b.HasOne("Medico.Domain.Models.Expression", "Expression")
                        .WithMany("ExpressionTemplates")
                        .HasForeignKey("ExpressionId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("Medico.Domain.Models.Template", "Template")
                        .WithMany("TemplateExpressions")
                        .HasForeignKey("TemplateId")
                        .OnDelete(DeleteBehavior.Restrict);
                });
