...
export class DrugHistoryComponent extends BaseHistoryComponent implements OnInit, AfterViewInit {
    ...
    private initSelectableLists() {
        const drugUseStatusListConfig = new SelectableListConfig(this.companyId, SelectableListsNames.drugHistory.drugUseStatus,
            LibrarySelectableListIds.drugHistory.drugUseStatus);

        const drugTypeListConfig = new SelectableListConfig(this.companyId, SelectableListsNames.drugHistory.drugType,
            LibrarySelectableListIds.drugHistory.drugType);

        const drugUseListConfig = new SelectableListConfig(this.companyId, SelectableListsNames.drugHistory.drugUse,
            LibrarySelectableListIds.drugHistory.drugUse);

        const drugUseRouteListConfig = new SelectableListConfig(this.companyId, SelectableListsNames.drugHistory.drugUseRoute,
            LibrarySelectableListIds.drugHistory.drugUseRoute);

        const durationListConfig = new SelectableListConfig(this.companyId, SelectableListsNames.application.duration,
            LibrarySelectableListIds.application.duration);

        const frequencyListConfig = new SelectableListConfig(this.companyId, SelectableListsNames.application.frequency,
