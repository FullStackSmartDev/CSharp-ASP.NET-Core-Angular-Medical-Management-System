...
export class BaseVitalSignsComponent {
    ...
    get oxygenUseListValues(): string[] {
        return this.selectableListService
            .getSelectableListValuesFromComponent(this, SelectableListsNames.vitalSigns.oxygenUseType);
    }
        ...
        this.baseVitalSignsService.save(this.baseVitalSignsCopy)
            .then((vitalSigns) => {
                this.patientChartTrackService
                    .emitPatientChartChanges(PatientChartNodeType.VitalSignsNode);
    ...
    private initSelectableLists() {
        const oxygenUseListConfig = new SelectableListConfig(this.companyId, SelectableListsNames.vitalSigns.oxygenUseType,
