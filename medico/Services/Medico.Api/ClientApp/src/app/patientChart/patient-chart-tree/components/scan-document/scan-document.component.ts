...
export class ScanDocumentComponent implements OnInit, AfterViewInit {
    ...
    createUpdateMedicalRecord() {
        const medicalRecordValidationResult =
            this.validateMedicalRecord(this.currentDocumentData);
        ...
        const confirmationPopup =
            this.alertService.confirm("Are you sure you want to update medical record?", "Confirm medical record saving");
        ...
        confirmationPopup.then(dialogResult => {
            if (dialogResult) {
                ...
                this.medicalRecordService.getById(medicalRecordId)
                    .then(medicalRecord => {
    ...
    get associatedDocumentationListValues(): string[] {
        return this.selectableListService
            .getSelectableListValuesFromComponent(this, SelectableListsNames.scanDocuments.associatedDocumentation)
    }
    ...
    private createMedicalRecord(currentDocumentData: any): Promise<void> {
        ...
        newMedicalRecord.createDate = currentDocumentData.createDate;
    ...
    private updateMedicalRecord(currentDocumentData: any): Promise<any> {
        return this.medicalRecordService
            ...
            .then(medicalRecord => {
                ...
                medicalRecord.createDate = currentDocumentData.createDate;
    ...
    public save() {
        const validationResult = this.scanDocumentForm.instance
            .validate();
    ...
    private uploadImageToServer(imageDataURI, fileName = "") {
        ...
        this.documentService.uploadFile(this.appointmentId, this.patientId, formdata).subscribe(
            response => {
                ...
                if (this.isSaveActionApplied) {//save new
    ...
    public saveAll() {
        ...
        this.documentService.save(this.document).then(document => {
            this.patientChartTrackService.emitPatientChartChanges(PatientChartNodeType.ScanDocumentNode);
        });
    ...
    private initSelectableLists() {
        const associatedDocumentationListConfig =
            new SelectableListConfig(this.companyId, SelectableListsNames.scanDocuments.associatedDocumentation,
