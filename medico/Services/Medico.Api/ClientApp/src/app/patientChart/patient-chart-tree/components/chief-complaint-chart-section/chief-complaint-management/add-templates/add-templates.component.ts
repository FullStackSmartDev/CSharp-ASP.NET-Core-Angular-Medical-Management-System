...
export class AddTemplatesComponent implements AfterViewInit {
    ...
    @Output() onTemplatesAdded: EventEmitter<any> = new EventEmitter();
    @Output() onTemplatesCanceled: EventEmitter<any> = new EventEmitter();
    ...
    addTemplates() {
        ...
        this.onTemplatesAdded.next(selectesTemplates);
        this.resetTemplates();
    }
    ...
    private loadTemplates(): void {
        this.templateService.getChiefComplaintTemplates(this.chiefComplaintId, this.companyId)
            .then(templates => {
