...
export class AllergyComponent extends BaseHistoryComponent implements OnInit, AfterViewInit {
        ...
        confirmationPopup.then(dialogResult => {
            if (dialogResult) {
                this.allergyService.delete(allergyId)
                    .then(() => {
                        this.patientChartTrackService.emitPatientChartChanges(PatientChartNodeType.AllergiesNode);
    ...
    private initSelectableLists() {
        const medicationReactionListConfig =
            new SelectableListConfig(this.companyId, SelectableListsNames.medications.medicationsAllergy,
