...
export class TobaccoHistoryComponent extends BaseHistoryComponent implements OnInit, AfterViewInit {
    ...
    private initSelectableLists() {
        const tobaccoUseStatusConfig = new SelectableListConfig(this.companyId,
            SelectableListsNames.tobaccoHistory.tobaccoUseStatus, LibrarySelectableListIds.tobaccoHistory.tobaccoUseStatus);

        const tobaccoTypeListConfig = new SelectableListConfig(this.companyId, SelectableListsNames.tobaccoHistory.tobaccoType,
            LibrarySelectableListIds.tobaccoHistory.tobaccoType);

        const tobaccoUseListConfig = new SelectableListConfig(this.companyId, SelectableListsNames.tobaccoHistory.tobaccoUse,
