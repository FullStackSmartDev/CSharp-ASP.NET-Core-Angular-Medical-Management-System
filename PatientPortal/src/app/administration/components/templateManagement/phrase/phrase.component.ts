...
import { AdminRichTextEditorComponent } from '../admin-template/admin-rich-text-editor/admin-rich-text-editor.component';
...
export class PhraseComponent extends BaseAdminComponent implements OnInit, OnDestroy {
    ...
    savePhrase() {
        ...
        this.selectableRoot.replaceSelectableItemsCodesWithDefaultValues(this.phrase.content)
            .then(contentWithDefaultSelectableItemsValues => {
                this.phrase.contentWithDefaultSelectableItemsValues =
                    contentWithDefaultSelectableItemsValues;
