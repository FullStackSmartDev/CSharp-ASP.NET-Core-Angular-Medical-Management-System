...
export class MedicoApplicationUserComponent extends BaseAdminComponent implements AfterViewInit, OnInit, OnDestroy {
    ...
    get nameSuffixes(): string[] {
        return this.selectableListService
            .getSelectableListValuesFromComponent(this, PredefinedSelectableListsNames.nameSuffix);
    }

    get namePrefixes(): string[] {
        return this.selectableListService
            .getSelectableListValuesFromComponent(this, PredefinedSelectableListsNames.namePrefix);
    }
    ...
    private initSelectableLists() {
        const nameSuffixListConfig =
            new SelectableListConfig(this.companyId, PredefinedSelectableListsNames.nameSuffix);
        const namePrefixListConfig =
            new SelectableListConfig(this.companyId, PredefinedSelectableListsNames.namePrefix);
