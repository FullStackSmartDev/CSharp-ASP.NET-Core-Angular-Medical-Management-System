...
export class VitalSignsComponent {
    ...
    get bloodPressurePositionListValues(): string[] {
        return this.selectableListService
            .getSelectableListValuesFromComponent(this, PredefinedSelectableListsNames.bloodPressurePosition);
    }

    get bloodPressureLocationListValues(): string[] {
        return this.selectableListService
            .getSelectableListValuesFromComponent(this, PredefinedSelectableListsNames.bloodPressureLocation)
    }

    get oxygenSatTestListValues(): string[] {
        return this.selectableListService
            .getSelectableListValuesFromComponent(this, PredefinedSelectableListsNames.oxygenSatTest)
    }
    ...
    private initSelectableLists() {
        const bloodPressurePositionListConfig =
            new SelectableListConfig(this.companyId, PredefinedSelectableListsNames.bloodPressurePosition);

        const bloodPressureLocationListConfig =
            new SelectableListConfig(this.companyId, PredefinedSelectableListsNames.bloodPressureLocation);

        const oxygenSatTestListConfig =
            new SelectableListConfig(this.companyId, PredefinedSelectableListsNames.oxygenSatTest);
    ...
    private setVitalSignsDefaultValues() {
        ...
        this.vitalSigns.bloodPressureLocation = this.selectableListService
            .getSelectableListDefaultValueFromComponent(this, PredefinedSelectableListsNames.bloodPressureLocation);

        this.vitalSigns.bloodPressurePosition = this.selectableListService
            .getSelectableListDefaultValueFromComponent(this, PredefinedSelectableListsNames.bloodPressurePosition);

        this.vitalSigns.oxygenSaturationAtRest = this.selectableListService
            .getSelectableListDefaultValueFromComponent(this, PredefinedSelectableListsNames.oxygenSatTest);
    }
