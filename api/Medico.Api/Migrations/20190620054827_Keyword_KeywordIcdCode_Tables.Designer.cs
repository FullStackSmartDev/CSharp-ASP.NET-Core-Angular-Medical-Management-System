...
namespace Medico.Api.Migrations
{
    ...
    [Migration("20190620054827_Keyword_KeywordIcdCode_Tables")]
    partial class Keyword_KeywordIcdCode_Tables
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Medico.Api.DB.Models.Addendum", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("Medico.Api.DB.Models.BaseVitalSigns", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasDefaultValueSql("newsequentialid()");
            ...
            modelBuilder.Entity("Medico.Api.DB.Models.Keyword", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasDefaultValueSql("newsequentialid()");
            ...
            modelBuilder.Entity("Medico.Api.DB.Models.KeywordIcdCode", b =>
                {
                    b.Property<Guid>("IcdCodeId");

                    b.Property<Guid>("KeywordId");

                    b.HasKey("IcdCodeId", "KeywordId");

                    b.HasIndex("KeywordId");

                    b.ToTable("KeywordIcdCode");
                });
            ...
            modelBuilder.Entity("Medico.Api.DB.Models.MedicalRecord", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasDefaultValueSql("newsequentialid()");
            ...
            modelBuilder.Entity("Medico.Api.DB.Models.SignatureInfo", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasDefaultValueSql("newsequentialid()");
            ...
            modelBuilder.Entity("Medico.Api.DB.Models.TemplateLookupItemTracker", b =>
                {
                    b.Property<Guid>("TemplateId");

                    b.Property<Guid>("TemplateLookupItemId");

                    b.Property<int>("NumberOfLookupItemsInTemplate");

                    b.HasKey("TemplateId", "TemplateLookupItemId");

                    b.ToTable("TemplateLookupItemTracker");
                });
            ...
            modelBuilder.Entity("Medico.Api.DB.Models.VitalSigns", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasDefaultValueSql("newsequentialid()");
            ...
            modelBuilder.Entity("Medico.Api.DB.Models.Addendum", b =>
                {
                    b.HasOne("Medico.Api.DB.Models.Admission", "Admission")
                        .WithMany("Addendums")
            ...
            modelBuilder.Entity("Medico.Api.DB.Models.BaseVitalSigns", b =>
                {
                    b.HasOne("Medico.Api.DB.Models.PatientDemographic", "Patient")
                        ...
                        .HasForeignKey("Medico.Api.DB.Models.BaseVitalSigns", "PatientId")
                        .OnDelete(DeleteBehavior.Restrict);
                });
            ...
            modelBuilder.Entity("Medico.Api.DB.Models.Employee", b =>
                {
                    b.HasOne("Medico.Api.DB.Models.AppUser", "AppUser")
                        .WithOne("Employee")
                        .HasForeignKey("Medico.Api.DB.Models.Employee", "AppUserId")
                        .OnDelete(DeleteBehavior.Cascade);
            ...
            modelBuilder.Entity("Medico.Api.DB.Models.KeywordIcdCode", b =>
                {
                    b.HasOne("Medico.Api.DB.Models.IcdCode", "IcdCode")
                        .WithMany("KeywordIcdCodes")
                        .HasForeignKey("IcdCodeId")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("Medico.Api.DB.Models.Keyword", "Keyword")
                        .WithMany("KeywordIcdCodes")
                        .HasForeignKey("KeywordId")
                        .OnDelete(DeleteBehavior.Cascade);
                });
            ...
            modelBuilder.Entity("Medico.Api.DB.Models.SignatureInfo", b =>
                {
                    b.HasOne("Medico.Api.DB.Models.Admission", "Admission")
                        ...
                        .HasForeignKey("Medico.Api.DB.Models.SignatureInfo", "AdmissionId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("Medico.Api.DB.Models.Employee", "Employee")
                        .WithMany("SignatureInfos")
